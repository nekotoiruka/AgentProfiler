...
- [ ] 14. REST API Routes と DI
  - [ ] 14.1 DI コンテナと dependencies 実装
...
- [ ] 17. Agent Manager + DB テーブル
  - [ ] 17.1 AgentManager 実装
...
- [ ] 20. Package Generator + Zip ダウンロード
  - [ ] 20.1 PackageGenerator 実装
  ...
  - [ ] 20.3 PackageGenerator のプロパティテスト
